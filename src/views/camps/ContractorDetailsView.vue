<template>
  <div class="ComponentWrapper">
    <div class="MGroup">
      ...
      <div class="MField" id="ContractNo">
        <input type="text" required />
  ...
  methods: {
    ComponentLoad() {
      ...
      if (this.$route.meta.Operation == 'EDIT') {
        ...
        document.getElementById('ContractNo').querySelector('input').value = this.GlobalsStore.MArray['contract_no'];
    ...
    Save() {
      ...
      Parameters.append('contract_no', document.getElementById('ContractNo').querySelector('input').value);
      ...
      if (Operation == 'ADD') {
        api.post('AddCampsContractor', Parameters, {
          headers: {
      ...
      if (Operation == 'EDIT') {
        api.post('EditCampsContractor', Parameters, {
          headers: {
            'Content-Type': 'multipart/form-data',
          }
        }).then(response => {
