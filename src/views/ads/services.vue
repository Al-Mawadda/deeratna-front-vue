  ...
  <div class="form-page">
    <div class="form-card">
      ...
      <div class="form-title">
        <h5>اعلانات الخدمات</h5>
      </div>

      <!-- Form Section -->
      <div v-if="hasPermission('ads_ser_view')" class="form-section">
...
export default {
  ...
  setup() {
    ...
    const fetchTableData = async () => {
      try {
        const response = await api.get('ads-get/services'); // Replace with your API endpoint
    ...
    const postSliderAd = async () => {
      try {
        ...
        formDataObj.append('type', 'services');
