<template>
  <div class="ComponentWrapper">
    <div v-if="GlobalsStore.CheckPermissions('electricity_ads_videos')" class="MGroup">
      ...
      <table v-if="GlobalsStore.CheckPermissions('main_screen_ads_videos')" class="table table-bordered">
        ...
        <tbody>
          <tr v-for="row in tableData" :key="row.id">
            ...
            <td>
              <button v-if="GlobalsStore.CheckPermissions('main_screen_ads_videos_delete')" class="btn btn-danger"
                @click="deleteRow(row)">
                حذف
              </button>
            </td>
