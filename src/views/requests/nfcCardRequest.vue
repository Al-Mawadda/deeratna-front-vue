    ...
    <MModal ref="NfcCardRequestModal" :Name="'NfcCardRequestModal'" :Title="' طلب ' +
      ...
      <table cellpadding="0" cellspacing="0" class="RequestsMTable" id="NfcCardRequestsTable">
        ...
        <tbody>
          ...
          <tr v-if="selectedRowData.request_type == 'اضافة' && selectedRowData.attributes.includes('سائق')">
            <td>وقت السماح من</td>
          ...
          <tr v-if="selectedRowData.request_type == 'ايقاف'">
            <td>سبب الايقاف</td>
            <td>{{ selectedRowData.suspension_reason }}</td>
          </tr>
      ...
      <div class="MGroup ModalMGroup"
        v-show="((selectedRowData.request_type == 'اضافة' && (selectedRowData.request_status == 'تم الدفع' || selectedRowData.request_status == 'تم')) || (selectedRowData.request_type == 'تمديد')) && (selectedRowData.department_id == 3 || UserData.department_id == 1)">
      ...
      <div class="MGroup ModalMGroup" id="GatesMGroup"
        v-show="(selectedRowData.request_type == 'اضافة' && (selectedRowData.request_status == 'تم الدفع' || selectedRowData.request_status == 'تم')) && (selectedRowData.department_id == 3 || UserData.department_id == 1)">
        <MCheckBox
