<template>
  <div class="ComponentWrapper">
    ...
    <MModal ref="InformationRequestModal" :Name="'InformationRequestModal'"
      ...
      <MTable ref="RquestCarsTB" :Name="'RquestCarsTB'" :DataArray="RquestCarsTBData" :Columns="RquestCarsTBColumns"
        :Sums="RquestCarsTBSums" :ShowFilterRow="false" :RowsPerPage="1000" v-show="Cars.length > 0">
      </MTable>

      <!--========== The Images ==========-->
      <div class="ImagesContainer">
        <div class="RequestImage" v-if="selectedRowData.personal_image != ''">
          <div class="RequestImageTitle">الصورة الشخصية</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.personal_image)">
            ...
            <img v-if="selectedRowData.personal_image" :src="ServerPath + '/storage/images/' + selectedRowData.personal_image
              " />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.id_image != ''">
          <div class="RequestImageTitle">بطاقة موحدة</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.id_image)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.id_image" :src="ServerPath + '/storage/images/' + selectedRowData.id_image" />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.id_image_back != ''">
          <div class="RequestImageTitle">ضهر البطاقة الموحدة</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.id_image_back)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.id_image_back" :src="ServerPath + '/storage/images/' + selectedRowData.id_image_back
              " />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.housing_image != ''">
          <div class="RequestImageTitle">بطاقة السكن</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.housing_image)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.housing_image" :src="ServerPath + '/storage/images/' + selectedRowData.housing_image
              " />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.housing_image_back != ''">
          <div class="RequestImageTitle">ضهر بطاقة السكن</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.housing_image_back)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.housing_image_back" :src="ServerPath +
              '/storage/images/' +
              selectedRowData.housing_image_back
              " />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.driver_licence_image != ''">
          <div class="RequestImageTitle">سنوية السائق</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.driver_licence_image)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.driver_licence_image" :src="ServerPath +
              '/storage/images/' +
              selectedRowData.driver_licence_image
              " />
          </div>
        </div>
        <div class="RequestImage" v-if="selectedRowData.driver_licence_image_back != ''">
          <div class="RequestImageTitle">ضهر سنوية السائق</div>
          <div class="RequestImagePreview" @click="ShowImage(selectedRowData.driver_licence_image_back)">
            <div class="RequestImagePreviewOverlay">
              <svg viewBox="0 0 1000 1000">
                <path
                  d="M450.2565,36.0294c18.6849,2.9482,37.5594,5.0146,56.0247,8.9843C653.55,76.6735,769.4424,197.507,794.0276,345.7818c18.3481,110.6581-7.8676,210.2677-77.061,298.56-1.47,1.8753-2.8516,3.8192-4.6057,6.1761q38.9827,40.554,77.7513,80.8829,70.1942,72.9948,140.3751,146.0021c20.5779,21.4581,20.7684,51.8715.7262,71.1147-20.2148,19.409-50.1806,18.0733-70.9443-3.48Q753.6258,834.3367,647.148,723.4766c-2.08-2.1635-3.9735-4.5069-6.357-7.2263-7.1169,4.4964-13.6031,8.6938-20.1838,12.7375C404.2984,861.8989,117.8611,741.5022,61.5828,494.0268A374.2062,374.2062,0,0,1,279.3051,66.0859,359.6555,359.6555,0,0,1,394.45,37.5392a50.3221,50.3221,0,0,0,6.9671-1.51ZM426.2127,686.3013c152.993-.5451,276.6613-124.73,275.9217-277.0737-.7433-153.105-124.6084-276.1761-277.355-275.5773-152.2376.5968-275.5054,124.7523-275.0328,277.0133C150.22,563.0212,274.4127,686.8422,426.2127,686.3013Z"
            ...
            <img v-if="selectedRowData.driver_licence_image_back" :src="ServerPath +
              '/storage/images/' +
    ...
    <!-- ========= Reject Model======== -->
    <MModal ref="InformationRequestRejectModal" :Name="'InformationRequestRejectModal'" :Title="'رفض الطلب'">
    ...
    <div class="MGroup">
      <MDate ref="InformationRequestsFromDate" :Name="'InformationRequestsFromDate'" :Label="'التاريخ'" :Range="true"
        :Clearable="true"></MDate>
    </div>
    <MTable ref="InformationRequestsTB" :Name="'InformationRequestsTB'" :DataArray="InformationRequestsTBData"
      :Columns="InformationRequestsTBColumns" :Sums="InformationRequestsTBSums"
      :GetDataFunction="GetInformationRequestsData" :RowsCount="InformationRequestsTBRowsCount" :RowsPerPage="10">
...
export default {
  setup() {
    ...
    return {
      ...
      Cars: ref([]),
      RquestCarsTB: ref(null),
      RquestCarsTBData: ref([]),
      RquestCarsTBSums: ref([]),
      RquestCarsTBColumns: [
        {
          name: 'car_number',
          label: 'رقم العجلة',
        ...
        {
          name: 'car_licence_image',
          label: 'السنوية',
          type: 'image',
        },
        {
          name: 'car_licence_back_image',
          label: 'ظهر السنوية',
          type: 'image',
        },
        {
          name: 'car_document_image',
          label: 'المستند',
          type: 'image',
        },
        {
  ...
  mounted() {
    ...
    document.getElementById('GetInformationRequestsBTN').addEventListener('click', function () {
      RequestStatusData = 1
      this.InformationRequestsTB.ReLoadMTable()
    }.bind(this))
    document.getElementById('GetInformationRequestsUnderReviewBTN').addEventListener('click', function () {
      RequestStatusData = 0
      this.InformationRequestsTB.ReLoadMTable()
    }.bind(this))
...
#InformationRequestModal .MModalWrapper {
  max-height: 90vh;
}

#InformationRequestModal .MModalContent {
  max-height: 90vh;
}
</style>
