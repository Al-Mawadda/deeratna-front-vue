  ...
  <div class="ComponentWrapper">
    <MModal ref="CarLabelRequestModal" :Name="'CarLabelRequestModal'" :Title="' طلب ' + selectedRowData.request_type + ' ملصق ' + selectedRowData.name
      ...
      <div class="MGroup ModalMGroup" id="GatesMGroup" v-show="selectedRowData.request_type == 'اضافة' && (selectedRowData.department_id == 3 || UserData.department_id == 1)">
        ...
        <MCheckBox
          :Disabled="true || !(selectedRowData.request_status == 'قيد المراجعة' && (UserData.department_id == 1 || (UserData.department_id == 3 && selectedRowData.department_id == 3)))"
    ...
    <MTable ref="CarLabelRequestsTB" :Name="'CarLabelRequestsTB'" :DataArray="CarLabelRequestsTBData"
      :Columns="CarLabelRequestsTBColumns" :Sums="CarLabelRequestsTBSums" :GetDataFunction="GetCarLabelRequestsData"
      :RowsCount="CarLabelRequestsTBRowsCount" :RowsPerPage="10">
