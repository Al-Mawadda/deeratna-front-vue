<template>
  <div class="ComponentWrapper">
    <div class="ModalContainer" id="CarLableRequestModal">
          ...
          <div class="ModalContent">
            ...
            <div class="MGroup ModalMGroup">
              ...
              <MDate
                ...
                :Visible="selectedRowData.request_type == 'اضافة'"
                ref="LabelIssue"
                :Name="'LabelIssue'"
                :Label="'تاريخ الانشاء'"
              ></MDate>
    ...
    <div class="ModalContainer" id="CarLableRequestRejectModal">
      <div class="ModalBackground">
        <div class="Modal">
          <div class="ModalHeaderRow">
      ...
      api
        ...
        .then(response => {
          ...
          if (response.data == 'تمت العملية بنجاح') {
            HideModal(document.getElementById('CarLableRequestModal'))
            this.CarLabelRequestsTB.LoadMTable()
          } else {
    ...
    SaveRejectRequest() {
      ...
      api
        ...
        .then(response => {
          ...
          if (response.data == 'تمت العملية بنجاح') {
            HideModal(document.getElementById('CarLableRequestModal'))
            HideModal(document.getElementById('CarLableRequestRejectModal'))
            this.CarLabelRequestsTB.LoadMTable()
          } else {
            ShowMessage(response.data)
          }
