<template>
  <div class="ComponentWrapper">
    ...
    <MTable ref="CustomersTB" :Name="'CustomersTB'" :DataArray="CustomersTBData" :Columns="CustomersTBColumns"
      :Sums="CustomersTBSums" :GetDataFunction="GetCustomersData" :RowsCount="CustomersTBRowsCount" :RowsPerPage="10">
