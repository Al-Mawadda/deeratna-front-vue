  ...
  <div class="ComponentWrapper">
    ...
    <MStepper ref="PersonStepper" :Name="'PersonStepper'">
      <div class="MStepContent" :Label="'المعلومات'">
        ...
        <div class="MField" id="Phone" v-show="CheckAttributes(['مالك', 'مستاجر', 'متعهد', 'كادر', 'موظف', 'زائر', 'سائق', 'استثناء'])">
          <input type="text" required />
        ...
        <div class="MField" id="OutsideAddress" v-show="CheckAttributes(['متعهد', 'كادر', 'عامل', 'موظف', 'زائر', 'سائق', 'استثناء'])">
          <input type="text" required />
          <label>العنوان</label>
          <div class="MFieldBG"></div>
        </div>
