  ...
  setup() {
    ...
    return {
      ...
      CarLabelsTBColumns: [
        ...
        { name: 'attributes.attribute', label: 'الصفة', filter: 'combo', filter_items: GlobalsStore.value.ComboBoxes?.Attributes || [] },
      ],
...
<style>
  ...
  .details { position:absolute; left: 8mm; right: 8mm; top: 32%;  display:grid; grid-template-columns: 1fr 1fr; gap: 0; }
  .col { padding: 5mm 6mm; }
