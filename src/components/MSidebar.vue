    ...
    <div class="MSidebarWrapper">
      <div class="MSidebarHeader">
        <div class="MSidebarHeaderIcon">
          <svg viewBox="0 0 1000 1000">
            <defs>
              <linearGradient id="linear-gradient" x1="402.1538" y1="1277.8733" x2="402.1538" y2="-164.1914" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stop-color="#e9521d" />
                <stop offset="1" stop-color="#fec605" />
              </linearGradient>
              <linearGradient id="linear-gradient-2" x1="357.4395" y1="1277.8733" x2="357.4395" y2="-164.1914" xlink:href="#linear-gradient" />
              <linearGradient id="linear-gradient-3" x1="504.7447" y1="1008.6024" x2="504.7447" y2="214.0492" xlink:href="#linear-gradient" />
            </defs>
            ...
            <path d="M302.8787,628.0223q3.6858,2.0122,7.4156,3.9534L501.429,544.5919,310.2943,631.9756Q306.5647,630.0346,302.8787,628.0223Z" style="fill: url(#linear-gradient)" />
            <polygon points="387.648 388.015 327.231 417.887 387.648 388.015 387.648 388.015" style="fill: url(#linear-gradient-2)" />
            <polygon points="960.588 755.819 887.388 722.145 695.507 633.874 501.429 544.592 310.294 631.976 121.727 718.186 39.412 755.819 124.368 727.451 352.797 651.176 501.429 601.546 653.157 652.525 884.946 730.404 960.588 755.819" />
            <polygon
            ...
            />
            <polygon points="485.852 294.149 450.882 317.427 450.882 336.067 485.852 314.615 485.852 294.149" style="fill: #e9521d" />
            <polygon points="450.882 396.233 450.882 416.83 485.852 397.378 485.852 376.781 450.882 396.233" style="fill: #e9521d" />
            <polygon points="485.852 334.84 450.882 354.292 450.882 376.009 485.852 356.557 485.852 334.84" style="fill: #e9521d" />
            <polygon points="450.882 539.208 485.852 522.279 485.852 499.253 450.882 518.705 450.882 539.208" style="fill: #e9521d" />
            <polygon points="450.882 498.48 485.852 479.029 485.852 458.179 450.882 477.631 450.882 498.48" style="fill: #e9521d" />
            <polygon points="450.882 457.406 485.852 437.954 485.852 417.603 450.882 437.055 450.882 457.406" style="fill: #e9521d" />
            <polygon points="614.368 481.506 575.399 503.182 575.399 523.534 614.368 501.857 614.368 481.506" style="fill: #e9521d" />
            <polygon points="614.368 440.684 575.399 462.361 575.399 482.958 614.368 461.281 614.368 440.684" style="fill: #e9521d" />
            <polygon points="614.368 522.081 575.399 543.758 575.399 546.446 592.54 555.782 614.368 544.32 614.368 522.081" style="fill: #e9521d" />
            <polygon points="614.368 358.665 575.399 381.971 575.399 400.194 614.368 378.518 614.368 358.665" style="fill: #e9521d" />
            <polygon points="614.368 398.742 575.399 420.419 575.399 442.136 614.368 420.459 614.368 398.742" style="fill: #e9521d" />
            <polygon points="372.648 412.165 342.231 427.204 342.231 445.555 372.648 430.636 372.648 412.165" style="fill: #e9521d" />
            <polygon points="372.648 450.861 342.231 467.78 342.231 489.497 372.648 472.578 372.648 450.861" style="fill: #e9521d" />
            <polygon points="342.231 570.895 372.648 553.976 372.648 533.624 342.231 550.543 342.231 570.895" style="fill: #e9521d" />
            <polygon points="342.231 509.722 342.231 530.319 372.648 513.4 372.648 492.803 342.231 509.722" style="fill: #e9521d" />
            <path
      ...
      <div class="MSidebarContent">
        <template v-for="(item, idx) in SidebarItems" :key="idx">
          <router-link v-if="!item.items" :to="item.route" v-show="!item.permission || GlobalsStore.CheckPermissions(item.permission)" class="MSidebarItem" active-class="router-link-active" exact-active-class="router-link-exact-active">
            <div class="MSidebarItemIcon" v-html="item.icon" />
            <div class="MSidebarItemText">{{ item.text }}</div>
          </router-link>
          <div v-else-if="item.items.some(child => !child.permission || GlobalsStore.CheckPermissions(child.permission))" class="MSidebarItemsGroup" :class="{ ActiveMSidebarItemsGroup: activeGroup === idx }">
            ...
            <div class="MSidebarItems">
              <router-link v-for="child in item.items" :key="child.route" v-show="!child.permission || GlobalsStore.CheckPermissions(child.permission)" :to="child.route" class="MSidebarItem" active-class="router-link-active" exact-active-class="router-link-exact-active">
        ...
        <div class="MSidebarItem" id="Logout" @click="Logout">
          <div class="MSidebarItemIcon">
            <svg viewBox="0 0 1000 1000">
              ...
              />
              <path d="M525.0742,316.1518q-.0014,91.2684-.0266,182.5368c-.0117,12.4775-8.976,23.2932-20.5322,25.2316a25.28,25.28,0,0,1-28.4692-16.9754,29.04,29.04,0,0,1-1.2871-9.2238q-.0927-181.3564-.0405-362.7131c.0028-15.3327,10.5229-26.4912,24.87-26.5859,14.8642-.0981,25.4657,10.9636,25.4737,26.7667Q525.1084,225.67,525.0742,316.1518Z" />
            </svg>
          </div>
